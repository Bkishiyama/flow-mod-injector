...
Purpose: This script creates fake but realistic SDN flow data for testing our 
FL anomaly detection system.
It generates:
- Normal benign traffic
- Attacks: DDoS, port scans, flow table exhaustion
Each client gets slightly different attack patterns to simulate real-world 
