...
This is what makes a this Denial of Service unique: it's tailored to avoid detection by monitoring systems that would normally catch a brute-force attack. Moreover, it takes advantage of a weakness, the unencrypted OpenFlow control channel, that's commonly found in most SDN research and production environments by default.
